...
<Playground>
  <View m={4} height={400}>
    <Map
      cluster
      apiKey={GOOGLE_MAPS_API_KEY}
      ClusterMarker={(props) => <Map.ClusterMarker {...props} bg="blue" color="yellow" />}
      MultiMarker={(props) => <Map.MultiMarker {...props} />}
    >
      {[
        ...
        <Map.Marker {...markers[0]} id={url} key={url} width={200} height={200}>
